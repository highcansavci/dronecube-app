      ...
      <div class="update-drone">
        ...
        <form id="regForm" class="requires-validation" novalidate>
          <div class="form-group">
            <h4>Drone Name</h4>
            <input class="form-control" type="text" name="name" v-model="drone.name" />
          </div>
          <div class="form-group">
          ...
          <div class="form-group">
            ...
            <div class="radio-group">
              <label class="radio-label">
                <input type="radio" name="connected" value="Connected" v-model="drone.connected" />
        ...
        <div class="modal-footer form-button-mt3">
          <button
            ...
            @click.stop.prevent="updateDrone"
          >
            Update
          </button>
...
const updateDrone = async () => {
  try {
    ...
    toastRef.value.showMessage({
      messages: `${data.name} is successfully updated`,
      type: 'success'
    })
...
.update-drone .modal-header h3 {
  font-size: 1.5rem; /* Reduced from 1.75rem */
  margin: 0;
}

.update-drone .btn-close {
  background: none;
  border: none;
  color: #fff;
...
.update-drone input::placeholder {
  color: #aaa;
}

.update-drone .form-group {
  margin-bottom: 20px;
}

.update-drone .drone-position {
  display: flex;
  gap: 15px;
  margin-bottom: 25px;
}

.update-drone .drone-position-item {
  display: flex;
...
.update-drone .btn-submit,
.update-drone .btn-secondary {
...
.update-drone .btn-submit:hover,
.update-drone .btn-secondary:hover {
