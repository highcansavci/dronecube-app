...
const { task, selectedTaskIds } = toRefs(props)

watch(
  selectedTaskIds,
  (newValue) => {
    isSelected.value = newValue.find((selectedTask) => selectedTask.id === task.value.id)
  },
  { deep: true }
)

const toggleSelection = () => {
  isSelected.value = selectedTaskIds.value.find((selectedTask) => selectedTask.id === task.value.id)
  if (isSelected.value) {
